        ...
        fab.setOnClickListener { _ ->
            ...
            if (projection.isInited()) {
                ...
                val record = Record(
                        ...
                        if (Core.getAudioChannels() != MyMediaRecorder.AudioChannels.SILENT) Core.audioEncoderString() else "-",
                        if (Core.getAudioChannels() != MyMediaRecorder.AudioChannels.SILENT) Core.getAudioEncodingBitRate().toString() else "-",
                        if (Core.getAudioChannels() != MyMediaRecorder.AudioChannels.SILENT) Core.getAudioSamplingRate().toString() else "-",
